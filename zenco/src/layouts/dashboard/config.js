    ...
    items: [
      ...
      ,
      {
        ...
        items: [
          {
            title: "Banner",
            path: paths.admin.dashboard.banner,
          },
          {
            title: "Product",
            items: [
              {
                title: "Category",
                path: paths.admin.dashboard.category,
              },
              {
                title: "Child-Category",
                path: paths.admin.dashboard.childCategory,
              },
              {
                title: "Product",
                path: paths.admin.dashboard.product,
              },
            ],
          },
          {
            title: "General",
            path: paths.admin.dashboard.general,
          },
          {
            title: "Partner",
            path: paths.admin.dashboard.partner,
          },
          {
            title: "Footer",
            path: paths.admin.dashboard.footer,
          },
          {
            title: "Chuyên mục",
            path: paths.admin.dashboard.news_category,
          },
        ],
      },
